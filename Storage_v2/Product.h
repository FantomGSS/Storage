...
public:
    Product();
    Product(const char*, Date, Date, const char*, const char*,
            unsigned short int, unsigned short int*, const char*);
    ...
    void setQuantity(const unsigned short int);
    ...
    const unsigned short int getQuantity() const;
    const unsigned short int* getPosition() const;
    const char* getComment() const;

    const bool isFit(Date date);
    void reduceQuantity(unsigned short int);
...
Product::Product(const char* name, Date expiryDate, Date dateOfReceipt, const char* manufacturersName, const char* unitOfMeasure,
                 unsigned short int quantity, unsigned short int* position, const char* comment) {
...
void Product::setQuantity(const unsigned short int quantity) {
    this->quantity = quantity;
}
...
const unsigned short int Product::getQuantity() const {
...
void Product::reduceQuantity(unsigned short int quantity) {
    this->quantity -= quantity;
}
